...
def pay_period_helper(start_date, end_date):
    ...
    end_date_obj = datetime.strptime(end_date, input_format)
...
def kwargs_edit_helper(kwargs_to_edit):
    ...
    start_date = kwargs_to_edit['start_date']
    end_date = kwargs_to_edit['end_date']

    pay_period = pay_period_helper(start_date, end_date)
    first_name = kwargs_to_edit['first_name']
    last_name = kwargs_to_edit['last_name']
    formatted_name = '{} {}'.format(first_name, last_name)

    kwargs_to_edit.pop('start_date')
    kwargs_to_edit.pop('end_date')
